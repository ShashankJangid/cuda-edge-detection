...
// Naive Global Memory Sobel Kernel (Direct uncached global memory reads)
__global__ void sobel_naive_kernel(
...
void sobel_filter_naive_gpu(
    ...
    sobel_naive_kernel<<<grid, block>>>(d_input, d_output, width, height);
